...
import eu.cise.console.config.audit.AuditEventConverter;
import eu.cise.console.domain.PersistentAuditEvent;
...
import static eu.cise.console.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
