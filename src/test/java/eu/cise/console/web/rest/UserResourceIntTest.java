...
import eu.cise.console.domain.Authority;
import eu.cise.console.domain.User;
import eu.cise.console.repository.UserRepository;
import eu.cise.console.repository.search.UserSearchRepository;
import eu.cise.console.security.AuthoritiesConstants;

import eu.cise.console.service.UserService;
import eu.cise.console.service.dto.UserDTO;
import eu.cise.console.service.mapper.UserMapper;
...
public class UserResourceIntTest {
     ...
     *
     * @see eu.cise.console.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
